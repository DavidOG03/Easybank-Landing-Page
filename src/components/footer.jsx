  ...
  return (
    <div className='footer'>
        <div className="footer-logo">
            <a href="#">
                <img src="/assets/images/logo-footer.svg" alt=" easybank logo" />
            </a>
        </div>
        ...
        <button className='footer-CTA-btn'>Request Invite</button>
        <small>© Easybank. All Rights Reserved</small>
        <small className='acknowledgement' style={{display:'block', textAlign:"center", paddingBlock:'1rem'}}>
     Challenge by <a href="#">Frontend Mentor</a>. Coded by <a href="#">David_OG</a>.
     </small>
    </div>
  )
}
